...
use Buseta\NomencladorBundle\Form\GrupoType;
...
class GrupoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NomencladorBundle:Grupo')->findAll();

        return $this->render('NomencladorBundle:Grupo:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('NomencladorBundle:Grupo:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NomencladorBundle:Grupo')->find($id);
        ...
        return $this->render('NomencladorBundle:Grupo:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('NomencladorBundle:Grupo:edit.html.twig', array(
            'entity'      => $entity,
