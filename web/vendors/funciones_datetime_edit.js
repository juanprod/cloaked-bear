...
if($('textarea#buseta_databundle_autobus_barras').val().length > 0)
{
    $('textarea#buseta_databundle_autobus_barras').fadeIn();
    $('label#barras').fadeIn();
    $("input#barras").attr('checked','checked');
}
else
{
...
if($('textarea#buseta_databundle_autobus_rampas').val().length > 0)
{
    $('textarea#buseta_databundle_autobus_rampas').fadeIn();
    $('label#rampas').fadeIn();
    $("input#rampas").attr('checked','checked');
}
else
{
...
if($('textarea#buseta_databundle_autobus_camaras').val().length > 0)
{
    $('textarea#buseta_databundle_autobus_camaras').fadeIn();
    $('label#camaras').fadeIn();
    $("input#camaras").attr('checked','checked');
}
else
{
...
if($('textarea#buseta_databundle_autobus_lector_cedulas').val().length > 0)
{
    $('textarea#buseta_databundle_autobus_lector_cedulas').fadeIn();
    $('label#lector').fadeIn();
    $("input#lector").attr('checked','checked');
}
else
{
...
if($('textarea#buseta_databundle_autobus_publicidad').val().length > 0)
{
    $('textarea#buseta_databundle_autobus_publicidad').fadeIn();
    $('label#publicidad').fadeIn();
    $("input#publicidad").attr('checked','checked');
}
else
{
...
if($('textarea#buseta_databundle_autobus_gps').val().length > 0)
{
    $('textarea#buseta_databundle_autobus_gps').fadeIn();
    $('label#gps').fadeIn();
    $("input#gps").attr('checked','checked');
}
else
{
...
if($('textarea#buseta_databundle_autobus_wifi').val().length > 0)
{
    $('textarea#buseta_databundle_autobus_wifi').fadeIn();
    $('label#wifi').fadeIn();
    $("input#wifi").attr('checked','checked');
}
else
{
